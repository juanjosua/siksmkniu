...
Route::get('/superadmin_dataPegawai/deactivate/{id}', 'SuperadminController@deactivateUser');
Route::get('/superadmin_dataPegawai/activate/{id}', 'SuperadminController@activateUser');
